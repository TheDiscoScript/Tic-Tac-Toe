...
const gameBoard = (() =>{
    ...
    const stopGame = () =>{
        let wholeBoard = buildingBoard.querySelectorAll("div")
        wholeBoard.forEach(block => block.removeEventListener("click", updateBoard))
        clearBoard()
    ...
    //TODO - clear board
    return {createBoard, clearBoard, inBoard, showBoardStatus, alerWin, stopGame  }
})();
